...
//    private SmileRating mRatingBar;
  //  private DatabaseReference mRatingBarCh;
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        else Toast.makeText(Upload_Recipe.this, "You haven't picked an image", Toast.LENGTH_SHORT).show();
    }
...
.child(myCurrentDateTime).setValue(foodData).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(Upload_Recipe.this, "Post Uploaded", Toast.LENGTH_SHORT).show();
